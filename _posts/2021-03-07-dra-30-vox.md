...
There is a 5 minute PTT timeout in case something goes wrong, after which PTT is released until the audio level drops out, at which time the timer is automatically reset.
